# 01_weather 16:9 Illustration Assets

Generated with the built-in image generation tool for the `01_weather` picture book series.

## Current generated set

- Output directory: `01_weather/illustrations_16x9`
- Image format: PNG
...
- Scope currently completed:
  ...
  - 16 interior illustrations for Vol02 `Vol02_raindrop.md`
...
- `vol01_cover_cloud.png`
- `vol01_scene01_sky_village.png` through `vol01_scene18_window_ending.png`
- `vol02_cover_raindrop.png`
- `vol02_scene01_cloud_slide.png` through `vol02_scene16_window_wink.png`
- `vol03_cover_sun.png`
- `vol03_scene01_dawn_alarm.png` through `vol03_scene16_sunset_moon_highfive.png`
- `vol04_cover_thunder.png`
...
- Simple rounded kawaii-style characters
- Gentle gouache / flat illustration texture
- No in-image text, letters, labels, titles, or watermarks
